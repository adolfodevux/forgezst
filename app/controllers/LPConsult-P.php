                        ...
                        <div class="col-md-3">
                            <div class="card mb-4">
                                <img class="card-img-top"
                                    src="data:<?php echo $producto['tipo_imagen']; ?>;base64,<?php echo base64_encode($producto['datos_imagen']); ?>"
                                    alt="<?php echo $producto['nombre_imagen']; ?>">
                                <div class="card-body">
                                    <h5 class="card-title">Nombre: <?php echo htmlspecialchars($producto['nombre']); ?></h5>
                                    <p class="card-text" style="font-style: oblique;">Descripcion: <br>
